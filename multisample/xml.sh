...
RELEASE_TIME_VERY_SHORT="0x80000000"
RELEASE_TIME_SHORT="0xA0000000"
RELEASE_TIME_MEDIUM="0x1E000000"


# DOES NOT SEEM TO WORK with param map..
...
EOF)
		...
		templateLower="${templateLower/__RELEASE_TIME__/$RELEASE_TIME}"
